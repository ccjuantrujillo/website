  ...
  <body class="fondo">
    ...
    <div class="container">
      ...
      <div class="row fondo">
        ...
        <!-- Post Content Column -->
        <div class="col-lg-8">
          <h4 class="mt-4">EL SANTO ROSARIO Y LA VIRGEN MARIA </h4>
          <blockquote class="blockquote">
            <p class="mb-0"><b>1. SENAL DE LA CRUZ </b></p>
          </blockquote>
		  
          <p>Por la senal de la Santa Cruz, <br>
          de nuestros enemigos, libranos Senor,<br>
            Dios nuestro. En el nombre del Padre,<br>
            y del Hijo, y del Espiritu Santo. Amen..</p>

          <blockquote class="blockquote">
            <p class="mb-0"><b>CREDO</b></p>
          </blockquote>
