    ...
    <div class="container">
      ...
      <div class="row fondo">
        ...
        <div class="col-lg-8">
          ...
          <!-- Post Content -->
          <p class="lead">"El cristiano(a) debera ser prudente, a veces tambien astuto: estas son virtudes aceptadas por la logica evangelica. Pero la violencia jamas. Para derrocar al mal, no se puede compartir los metodos del mal  ". (Papa Francisco) </p>

          <blockquote class="blockquote">
            <p class="mb-0"><b>Antifona de entrada</b></p>
            <footer class="blockquote-footer">Cf. Sal 67,6-7. 36 </footer>
          </blockquote>
		  
          <p>Yo soy la salvacion del pueblo, dice el Senor. Cuando me invoquen en la tribulacion, los escuchare y sere para siempre su Senor.</p>
          ...
          <p>
		  	S. Salvador nuestro Senor: Senor, ten piedad.<br>
		  	R: Senor, ten piedad.<br>
		  	S. Redentor nuestro: Cristo, ten piedad.<br>
		  	R: Cristo, ten piedad.<br>
		  	S. Mediador nuestro: Senor, ten piedad.<br>
		  	R: Senor, ten piedad.
          </p>
          <blockquote class="blockquote">
