  ...
  <body class="fondo">
    ...
    <div class="container">
      ...
      <div class="row fondo">
        ...
        <!-- Post Content Column -->
        <div class="col-lg-8">
          <h4 class="mt-4">XXVI DOMINGO DEL TIEMPO ORDINARIO</h4>
          <h4 class="mt-1">Invitados a la caridad </h4>		  
          <p>Publicado el 29 Setiembre, 2019</p>
          ...
          <blockquote class="blockquote">
            ...
            <footer class="blockquote-footer">Cf. Dn 3,31.29.30.43.42 </footer>
          </blockquote>
		  
          <p>Cuanto has hecho con nosotros, Senor es un castigo merecido, por que hemos pecado contra ti y no hemos obedecido tus mandamientos; pero da gloria a tu nombre y tratanos segun tu gran misericordia. </p>
          ...
          <p>
		  	S. En ti creemos: Senor ten piedad.<br>
		  	R. Senor ten piedad.<br>
		  	S. Queremos convertirnos a ti: Cristo ten piedad.<br>
		  	R. Cristo ten piedad.<br>
		  	S. En ti ponemos nuestra esperanza: Senor ten piedad.<br>
		  	R. Senor ten piedad.
</p>
          <blockquote class="blockquote">
		  ...
		  <p>Oh, Dios, que manifiestas tu poder sobre todo con el perdon y la misericordia, aumenta en nosotros tu gracia, para que, aspitando a tus promesas, nos hagas participar de los bienes del cielo. Por nuestro Senor Jesucristo. </p>
          ...
          <blockquote class="blockquote">
			...
			Amos continua su ministerio profetico, denunciando el pecado y la injusticia imperante en Israel y les anuncia la consecuencia de ello, que los llevara a la esclavitud. </footer>
          </blockquote>
          ...
          <blockquote class="blockquote">
            ...
            <footer class="blockquote-footer">R. Alaba, alma mia, al Senor </footer>
          </blockquote>

          <p>- El mantiene su fidelidad perpetuamente, el hace justicia a los oprimidos, el da pan a los hambrientos. El Senor liberta a los cautivos./ R.<br>
            - El Senor abre los ojos al ciego, endereza a los que ya se doblan, el Senor ama a los justos, el Senor guarda a los peregrinos
          / R..<br>
          - Sustenta al huerfano y a la viuda y trastorna el camino de los malvados. El senor reina eternamente, tu Dios, Sion, de edad en edad./ R. </p>
          <blockquote class="blockquote">
            <p class="mb-0"><b>2da Lectura</b></p>
            <footer class="blockquote-footer">Pablo nos invita a buscar la virtud en nuestra vida, que nos impulsa a la vida eterna en comunidad fraterna en la iglesia, y produce en nosotros alabanza a Dios todopoderoso. <br>
          ...
          <blockquote class="blockquote">
            ...
            <footer class="blockquote-footer">Lucas, en clave de futuro, nos invita a ver nuestra historia cuando ella ignora a Dios en su camino y desarrollo, por ende se olvida de la presencia de la dimension de fraternidad y misericordia. <br>
...
<p>R. Gloria a ti, Señor.<br>
  ...
  Palabra del Señor. R. Gloria a ti, Señor Jesús</p>
		  ...
		  <p>S. Dios Padre Nuestro, escucha estas peticiones que te hacemos con fe y humildad. Recibelas benignamente y hazlas tuyas. Respondemos:<br>
		    R. Danos un corazon generoso.<br>
		    - Por el Papa Francisco, el obispo de nuestra diocesis y por todos los obispos de la tierra; para que a ejemplo de los apostoles sepan instruir al pueblo cristiano con los valores del Reino. Roguemos al Senor. /R.<br>
		    - Por los responsables de la Economia en todo el mundo; para que sus decisiones esten impregnadas en el pensamiento de Cristo y asi favorezcan a los mas pobres y desposeidos. Roguemos al Senor. /R.<br>
		    - Para que nos comprometamos a tener una formacion constante en el descubrimiento de la Palabra de Dios y que al estudiarla, la hagamos vida en nuestras vidas. Roguemos al Senor./ R.<br>
		    - Por los pobres, los enfermos, los perseguidos, los marginados; para que el apoyo de los hermanos y hermanas les sirva para salir de sus problemas y dolencias. Roguemos al Senor./ R.<br>
		    - Por nosotros, reunidos en esta Eucaristia; para que seamos testigos del amor de Jesus de Nazaret sobre todo, a los mas pobres de este mundo. Roguemos al Senor./ R.<br>
		    (Pueden anadirse peticiones particulares)<br>
		    S. Y todo esto te lo pedimos por el mismo Jesucristo, tu Hijo, que vive y reina contigo en la unidad del Espiritu Santo. <strong>Amen</strong>.</p>	  

          <blockquote class="blockquote">
            <p class="mb-0"><b>Oracion sobre las ofrendas</b></p>
            <footer class="blockquote-footer">Conedenos, Dios de misericordia, aceptar esta ofrenda nuestra y que, por ella, se abra para nosotros la fuente de toda bendicion. <br>
			Por Jesucristo, nuestro Senor.
        </footer>
          </blockquote>

          <blockquote class="blockquote">
            <p class="mb-0"><b>Antifona de comunion Sal 118, 49-50</b></p>
            <footer class="blockquote-footer">Recuerda la palabra que diste a tu siervo, Senor, de la que hiciste mi esperanza; este esmi consuelo en la afliccion. </footer>
          </blockquote>

          <blockquote class="blockquote">
            <p class="mb-0"><b>Oracion despues de la comunion</b></p>
            <footer class="blockquote-footer">Senor, que el sacrramento del cielo renueve nuestro cuerpo y espiritu, para que seamos coherederos en la gloria de aquel cuya muerte hemos anunciado y compartido. El, que vive y reina por los siglos de los siglos. </footer>
          </blockquote>

          <blockquote class="blockquote">
            <p class="mb-0"><b>La palabra en la semana </b></p>
            <footer class="blockquote-footer">30 L San Jeronimo (MO) <br>
              1 M Santa Teresa del Nino Jesus (MO) <br>
              2 M Santos Angeles Custodios (MO) <br>
              3 J Feria <br>
              4 V San Francisco de Asis (MO) <br>
              5 S Santa Maria en Sabado (ML) </footer>
          </blockquote>
